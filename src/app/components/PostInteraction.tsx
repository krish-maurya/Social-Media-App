...
const PostInteraction = ({ count, isLiked, isReposted, isSaved }: { count: { likes: number, rePostedBy: number, comments: number }, isLiked: boolean, isReposted: boolean, isSaved: boolean }) => {
    return (
        <div className="flex items-center justify-between my-2 gap-4 lg:gap-16 text-textGray">
            <div className=" flex items-center justify-between flex-1">
                ...
                <div className="flex items-center gap-2 cursor-pointer group">
                    ...
                    <span className={`${isReposted ? "text-iconGreen" : "text-textGray"}  group-hover:text-iconGreen text-sm`}>{count.rePostedBy}</span>
                </div>
                {/* LIKE */}
                <div className="flex items-center gap-2 cursor-pointer group">
                    <svg
