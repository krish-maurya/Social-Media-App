        ...
        <SignIn.Root>
          ...
          <SignIn.Step name="start">
            <Clerk.Field name="identifier" className="flex flex-col gap-2">
              <Clerk.Input placeholder="john@gmail.com" className="py-2 px-6 rounded-full Otext-black w-72 placeholder: text-sm" />
              <Clerk.FieldError className="text-red-300 text-sm" />
            </Clerk.Field>
            <SignIn.Action submit className="mt-3 w-72 text-center text-sm font-medium text-iconBlue hover:text-iconBlue/80  transition-colors">Continue</SignIn.Action>
          </SignIn.Step>
          <SignIn.Step name="verifications">
            <SignIn.Strategy name="password">

              <Clerk.Field name="password" className="flex flex-col gap-2">
                <Clerk.Input placeholder="password" className="py-2 px-6 rounded-full Otext-black w-72 placeholder: text-sm" />
                <Clerk.FieldError className="text-red-300 text-sm" />
              </Clerk.Field>
              <div className="flex flex-col  gap-2">
                <SignIn.Action submit className="mt-2 text-sm  w-72 text-center text-iconBlue">Continue</SignIn.Action>
            ...
            <SignIn.Strategy name="reset_password_email_code">
              ...
              <Clerk.Field name="code" className="flex flex-col gap-2">
                <Clerk.Input className="py-2 px-6 rounded-full Otext-black w-72 placeholder: text-sm" placeholder='Verification code' />
                <Clerk.FieldError className="text-red-300 text-sm" />
              </Clerk.Field>
          ...
          <SignIn.Step name="forgot-password" className='flex justify-between w-72 text-sm'>
            ...
            <SignIn.Action navigate="previous" className=''>Go back</SignIn.Action>
          </SignIn.Step>
